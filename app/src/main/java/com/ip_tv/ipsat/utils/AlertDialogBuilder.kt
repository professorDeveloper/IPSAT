...
class AlertDialogBuilder(private val context: Context) {
    ...
    fun setCancelable(cancelable: Boolean): com.ip_tv.ipsat.utils.AlertDialogBuilder {
        this.cancelable = cancelable
        return this
    }

    fun setOnShowListener(onShow: () -> Unit): com.ip_tv.ipsat.utils.AlertDialogBuilder {
        this.onShow = onShow
        return this
    }
