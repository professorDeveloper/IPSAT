...
@HiltViewModel
class ShowMoreSeriesViewModel @Inject constructor(private val repository: HomeRepository):ViewModel(){
    ...
    fun loadSearch(r: SearchResults) {
        viewModelScope.launch {
            repository.filterSeries(r).onEach {
                it.onSuccess {
    ...
    fun loadNextPage(r: SearchResults) {
        ...
        viewModelScope.launch {
            repository.filterSeries(data).onEach {
                it.onFailure {
