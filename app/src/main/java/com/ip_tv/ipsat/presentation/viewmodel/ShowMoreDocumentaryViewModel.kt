...
@HiltViewModel
class ShowMoreDocumentaryViewModel @Inject constructor(private val repository: HomeRepository):ViewModel(){
    ...
    fun loadSearch(r: SearchResults) {
        viewModelScope.launch {
            repository.filterDocumentary(r).onEach {
                it.onSuccess {
    ...
    fun loadNextPage(r: SearchResults) {
        ...
        viewModelScope.launch {
            repository.filterDocumentary(data).onEach {
                it.onFailure {
