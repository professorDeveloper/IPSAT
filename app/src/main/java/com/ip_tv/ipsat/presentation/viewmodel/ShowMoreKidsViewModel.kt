...
@HiltViewModel
class ShowMoreKidsViewModel @Inject constructor(private val repository: HomeRepository) : ViewModel() {
    ...
    fun loadSearch(r: SearchResults) {
        viewModelScope.launch {
            repository.filterKids(r).onEach {
                it.onSuccess {
    ...
    fun loadNextPage(r: SearchResults) {
        ...
        viewModelScope.launch {
            repository.filterKids(data).onEach {
                it.onFailure {
